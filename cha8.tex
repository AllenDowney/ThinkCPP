...
apstring}s are different in the sense that they are made up of smaller
pieces, the characters.  Thus, {\tt apstring}s are an example of a
{\bf compound} type.
...
In the header file {\tt iostream.h},
...
\end{verbatim}
%
{\tt cin} can also be used to input an {\tt apstring}:
...
function defined in the header file {\tt stdlib.h}.  We will
